...
public class UnitOfWork : IUnitOfWork
{
    ...
    private IAsyncRepository<ApplicationUser> _applicationUserRepository;
    ...
    public IAsyncRepository<ApplicationUser> ApplicationUserRepository
    {
        get
        {
            return _applicationUserRepository ??= new BaseRepository<ApplicationUser>(_context);
        }
    }
